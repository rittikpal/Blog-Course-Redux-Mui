...
import { STATUSES, fetchblogsCategory } from "../../Redux/Slice/Blogsbycategoryslice";
...
const BlogsByCategory = () => {
  ...
  const { data: blogsCategories, status }=useSelector((state) => state?.blogsCategory)

  const { categoryId } = useParams()
    useEffect(() => {
     
         dispatch(fetchblogsCategory(categoryId ));
